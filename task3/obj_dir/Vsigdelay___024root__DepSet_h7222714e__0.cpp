...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    SData/*8:0*/ __Vdlyvdim0__sinegen__DOT__delayram__DOT__ram_array__v0;
    CData/*7:0*/ __Vdlyvval__sinegen__DOT__delayram__DOT__ram_array__v0;
    CData/*0:0*/ __Vdlyvset__sinegen__DOT__delayram__DOT__ram_array__v0;
    // Body
    __Vdly__sinegen__DOT____Vcellout__addrCounter__count 
        = vlSelf->sinegen__DOT____Vcellout__addrCounter__count;
    __Vdlyvset__sinegen__DOT__delayram__DOT__ram_array__v0 = 0U;
    __Vdly__sinegen__DOT____Vcellout__addrCounter__count 
        = ((IData)(vlSelf->rst) ? 0U : (0xffU & ((IData)(vlSelf->sinegen__DOT____Vcellout__addrCounter__count) 
                                                 + (IData)(vlSelf->wr))));
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sinegen__DOT__delayram__DOT__ram_array
            [vlSelf->sinegen__DOT____Vcellout__addrCounter__count];
    }
    if (vlSelf->wr) {
        __Vdlyvval__sinegen__DOT__delayram__DOT__ram_array__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sinegen__DOT__delayram__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sinegen__DOT__delayram__DOT__ram_array__v0 
            = (0x1ffU & ((IData)(vlSelf->sinegen__DOT____Vcellout__addrCounter__count) 
                         + (IData)(vlSelf->offset)));
    }
    vlSelf->sinegen__DOT____Vcellout__addrCounter__count 
        = __Vdly__sinegen__DOT____Vcellout__addrCounter__count;
    if (__Vdlyvset__sinegen__DOT__delayram__DOT__ram_array__v0) {
        vlSelf->sinegen__DOT__delayram__DOT__ram_array[__Vdlyvdim0__sinegen__DOT__delayram__DOT__ram_array__v0] 
            = __Vdlyvval__sinegen__DOT__delayram__DOT__ram_array__v0;
    }
}
