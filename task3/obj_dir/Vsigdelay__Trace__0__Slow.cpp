...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,(vlSelf->sinegen__DOT____Vcellout__addrCounter__count),9);
    bufp->fullSData(oldp+9,((0x1ffU & ((IData)(vlSelf->sinegen__DOT____Vcellout__addrCounter__count) 
                                       + (IData)(vlSelf->offset)))),9);
    bufp->fullCData(oldp+10,(vlSelf->sinegen__DOT____Vcellout__addrCounter__count),8);
